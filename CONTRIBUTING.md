...
When contributing to this repository, please first discuss the change you wish to make via an [issue](https://github.com/benmaier/DiffLimAgg/issues/new).

Please note we have a [code of conduct](https://github.com/benmaier/DiffLimAgg/blob/master/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
...
3. Increase the version number in [DiffLimAgg/metadata.py](https://github.com/benmaier/DiffLimAgg/blob/master/DiffLimAgg/metadata.py) and the README.md to the new version that this
